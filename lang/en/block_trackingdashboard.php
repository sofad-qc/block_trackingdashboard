...
$string['courseLastActivity'] = 'Last activity';
...
$string['noEndDate'] = 'No end date for this course';
$string['waitingGradedWork'] = 'Activities waiting for grading';
$string['noWaitingGradedWorkActivity'] = 'No activity waiting for grading';
